...
select * from EMPLOYEE.TableName_269905 where location like 'chicago'; 

--select * from EMPLOYEE.TableName_269905 where location regexp_substr(chicago , 'i')'; 


SELECT REGEXP_SUBSTR('mint chocolate chip', 'ch(i|o)p', 1, 1, 'c');

SELECT REGEXP_SUBSTR('mint chocolate chop', 'ch(i|o)p', 1, 1, 'c');
